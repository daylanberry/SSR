...
exports.default = {
  component: (0, _reactRedux.connect)(mapStateToProps, { fetchAdmins: _actions.fetchAdmins })((0, _requireAuth2.default)(AdminPage)),
  loadData: function loadData(_ref2) {
    var dispatch = _ref2.dispatch;
...
exports.default = function (ChildComponent) {
  var RequireAuth = function (_Component) {
    ...
    function RequireAuth(props) {
      ...
      return _possibleConstructorReturn(this, (RequireAuth.__proto__ || Object.getPrototypeOf(RequireAuth)).call(this, props));
    }
  ...
  return (0, _reactRedux.connect)(mapStateToProps, null)(RequireAuth);
};
